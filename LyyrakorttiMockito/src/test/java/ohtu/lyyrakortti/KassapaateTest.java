...
public class KassapaateTest {
    ...
    @Test
    public void kassapaatteenMetodiLataaLisaaKortilleRahaaJosLadattavaSummaOnPositiivinen() {
    ...
    @Test
    public void kassapaatteenMetodinLataaEiTeeLyyrakortilleMitaanJosLadattavaSummaOnNegatiivinen() {
        when(kortti.getSaldo()).thenReturn(4);
        kassa.lataa(kortti, -12);
